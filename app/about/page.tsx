...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://luminamedspa.agency/about" },
};
...
const values = [
  ...
  },
  {
    ...
    body: "We specialize in med spas and aesthetic medicine. That means HIPAA-eligible infrastructure as a default, communication templates built around patient norms, and pricing anchored to the economics of a practice — not generic SaaS.",
  },
];
...
export default function AboutPage() {
  return (
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
          <div>
            ...
            <p className="text-[15px] lg:text-[17px] text-[#6B6898] leading-relaxed mb-5">
          ...
          <div>
            ...
            <p className="text-[15px] lg:text-[17px] text-[#6B6898] leading-relaxed mb-5">
              ...
              entry band while keeping margin strong enough to reinvest into the
              next tier.
            </p>
            <p className="text-[15px] lg:text-[17px] text-[#6B6898] leading-relaxed mb-5">
      ...
      {/* Values */}
      <section className="bg-[#F0EDFF] border-y border-[#DDD8FF] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {values.map((v) => (
              <div
                key={v.title}
                className="bg-white rounded-2xl p-8 border border-[#DDD8FF]"
              >
                <h3 className="font-medium text-[17px] mb-3">{v.title}</h3>
                <p className="text-[15px] lg:text-[17px] text-[#6B6898] leading-relaxed">{v.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 md:py-24 text-center">
        ...
        <p className="text-[15px] lg:text-[17px] text-[#6B6898] leading-relaxed max-w-xl mx-auto mb-16">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto">
          {marketStats.map((s) => (
            <div key={s.value}>
              <div className="font-serif text-3xl font-normal text-[#160E3C] mb-2">
                {s.value}
              </div>
              <div className="text-[12px] text-[#9184C4] leading-relaxed">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-[#160E3C] text-white">
        <div className="max-w-3xl mx-auto px-6 py-20 md:py-24 text-center">
          ...
          <Link
            href="/booking"
            className="inline-block bg-[#9B8DFF] text-white font-medium px-10 py-4 rounded-full hover:bg-white transition-colors text-[15px] tracking-wide focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#160E3C]"
          >
