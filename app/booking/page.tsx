      ...
      <PageTransition>
        <section className="flex min-h-[75vh] items-center justify-center px-6">
          <div className="max-w-md text-center">
            ...
            <h1 className="text-4xl font-semibold tracking-[-0.04em] text-obsidian">We&apos;ll be in touch.</h1>
            <p className="mt-6 text-sm leading-relaxed text-iron">We&apos;re just getting started — you may be eligible for discounted case studies and testimonials. Reach out to your referrer or email us at <a href="mailto:contact@delytica.com" className="font-semibold text-ember hover:underline">contact@delytica.com</a>.</p>
